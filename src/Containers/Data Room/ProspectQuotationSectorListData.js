...
import {getProspectSectorOpenData,updateOpportunitydragstage} from "./DataRoomAction"
...
function ProspectSectorListData(props) {
...
let type="Quotation"
  ...
  useEffect(() => {
    ...
    props.getProcessForOpportunity(props.orgId,type);
     props.getProspectSectorOpenData( props.selectedPropsectSector.sectorId)
    }
                                    ...
                                    >
                                      {props.prospectSectorOpen
                                        ...
                                        .map((opp, index) => {
                                         ...
                                         {props.prospectSectorOpen.length === 0 && (
...
export default connect(mapStateToProps, mapDispatchToProps)(ProspectSectorListData)
