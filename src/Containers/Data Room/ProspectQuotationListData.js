...
import {getProspectOppOpenTask,updateOpportunitydragstage} from "./DataRoomAction"
...
let type="Quotation"
  ...
  useEffect(() => {
    ...
    props.getProcessForOpportunity(props.orgId,type);
     props.getProspectOppOpenTask(props.selectedPersonData.customerId)
    }
                                    ...
                                    >
                                      {props.prospectOppOpenTask
                                        ...
                                        .map((opp, index) => {
                                         ...
                                         {props.prospectOppOpenTask.length === 0 && (
