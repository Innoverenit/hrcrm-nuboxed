  ...
  render() {
    ...
    return (
      ...
      {MileageDat.map((item) => { 
                    return (
                        <div>
                            <div className="flex justify-between mt-4 max-sm:flex-col scale-[0.99] hover:scale-100 ease-in duration-100 shadow-2xl  border-solid m-1  leading-3 hover:border  hover:border-[#23A0BE]  hover:shadow-[#23A0BE]"
                                style={{
