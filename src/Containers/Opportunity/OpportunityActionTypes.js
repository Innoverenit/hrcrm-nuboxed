...
export const ADD_MORE_CONTACT_REQUEST = "ADD_MORE_CONTACT_REQUEST";
export const ADD_MORE_CONTACT_SUCCESS = "ADD_MORE_CONTACT_SUCCESS";
export const ADD_MORE_CONTACT_FAILURE = "ADD_MORE_CONTACT_FAILURE";
...
export const SEND_EMAIL_STAGE_UPDATE_FAILURE =
  ...
  export const HANDLE_OPPORTUNITY_PULSE_MODAL =
  "HANDLE_OPPORTUNITY_PULSE_MODAL";



  export const GET_OPP_PULSE_DATA_REQUEST = "GET_OPP_PULSE_DATA_REQUEST";
export const GET_OPP_PULSE_DATA_SUCCESS = "GET_OPP_PULSE_DATA_SUCCESS";
export const GET_OPP_PULSE_DATA_FAILURE = "GET_OPP_PULSE_DATA_FAILURE";
