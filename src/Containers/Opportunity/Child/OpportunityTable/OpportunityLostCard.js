 ...
 <CardWrapper>      
              {lostOpportunity.map((item) => {
                 ...
                 return (
                  ...
                  <div>
                  <div
                    className="flex rounded-xl justify-between bg-white mt-[0.5rem] h-[2.75rem] items-center p-2 max-sm:h-[9rem] max-sm:flex-col"
                   
                  >
                     <div class="flex max-sm:justify-between max-sm:w-wk items-center">
                    <div className=" flex font-medium w-[14.5rem] max-xl:w-[9.5rem] max-sm:flex-row  ">
                              <div>
<SubTitle>
          <MultiAvatar
      ...
      {/* {date === currentdate ? (
        ...
        >
          New
                              ...
                              <div className=" flex font-medium flex-col  w-[11.1rem] max-xl:w-[5.7rem]  max-sm:flex-row  max-sm:justify-between ">
                              ...
                              <div class="flex max-sm:justify-between max-sm:w-wk items-center">
                              <div className=" flex font-medium flex-col w-[9.1rem] max-xl:w-[5rem] max-sm:flex-row  max-sm:justify-between ">
          ...
          />
                              ...
                              <div className=" flex font-medium items-center  w-[10.01rem] max-xl:w-[4.9rem] max-sm:flex-row  max-sm:justify-between ">
...
/>
                              ...
                              <div className=" flex font-medium items-center w-[5rem] max-xl:w-[4rem] max-sm:flex-row  max-sm:justify-between ">
