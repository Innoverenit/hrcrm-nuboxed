...
{ !fetchingCloseOpportunity && closeOpportunity.length === 0 ?<NodataFoundPage />:closeOpportunity.map((item,index) =>  {
                 ...
                 return (
                  ...
                  text-[#444444] m-3 p-1 w-[20vw] flex flex-col max-sm:w-wk scale-[0.99] hover:scale-100 ease-in duration-100 shadow-2xl  border-solid m-1 p-1 leading-3 hover:border  hover:border-[#23A0BE]  hover:shadow-[#23A0BE] ">
