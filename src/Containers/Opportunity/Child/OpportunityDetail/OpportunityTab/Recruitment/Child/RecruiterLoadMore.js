...
function RecruiterLoadMore(props) {
...
// // });
 ...
 const newSkill=props.recruiterList.map((item)=> {
   return { fullName:item, color: generateRandomColor() };
     });
...
export default RecruiterLoadMore;
