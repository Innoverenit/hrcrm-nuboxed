  ...
  return (
    <>
       ...
       <div className=" md:w-[8.1rem]">PO #</div>
        ...
        <div className="md:w-[5.8rem]">Bill To</div>
        <div className="md:w-[8.5rem]">Supplier</div>
        <div className="md:w-[8.5rem]">Analysis Name</div>
        <div className="md:w-[8.5rem]">Taxable</div>
        <div className="md:w-[8.5rem]">Total</div>
        <div className="md:w-[8.5rem]">Outstanding</div>
        <div className="md:w-[8.5rem]">GRN #</div>
...
const mapDispatchToProps = (dispatch) =>
  ...
  export default connect(mapStateToProps, mapDispatchToProps)(ProcurementPurchaseCard);
