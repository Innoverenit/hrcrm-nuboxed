...
function ProspectCustomerLevelToUserForm(props) {
  useEffect(() => {
  ...
  function buttonOnClick() {
    const data = {
      ...
      subProcessName: "Prospect Contact To User",
    };
...
export default connect(mapStateToProps, mapDispatchToProps)(ProspectCustomerLevelToUserForm);
