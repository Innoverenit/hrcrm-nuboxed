...
const ProspectCustomerLevelToUserForm = lazy(() => import("./ProspectCustomerLevelToUserForm"));
class ProspectContactToUserForm extends Component {
    constructor(props) {
        super(props);
        this.state = {
            approve: false,
 ...
 componentDidMount() {
     ...
     this.props.getApproveData( "Prospect Contact To User");
 }
    ...
    render() {
        ...
        >
                                ...
                                {values.approvalIndicator ? (
                                        ...
                                        <div class=" mt-4" >
                                        <ProspectCustomerLevelToUserForm
...
export default connect(mapStateToProps, mapDispatchToProps)(ProspectContactToUserForm);
