...
import BorderColorIcon from '@mui/icons-material/BorderColor';
 import {deleteProductionStagesData} from "../../../../../Settings/SettingsAction";
...
class SingleProductionStages extends Component {
  constructor(props) {
    super(props);
    this.formRef = null;
    this.state = {
  ...
  render() {
    ...
    console.log(productionProcessStages.productionStagesId);
    console.log(productionProcessStages);
    ...
    const {
      ...
      color,
      key,
      deleteProductionStagesData,
      currentStage,
    } = this.props;
    console.log(productionStagesId, "----------", linkedStages);
    ...
    const disableDelete = linkedStages && linkedStages.includes(productionStagesId);
    return (
      <StageWrapper>
        <ViewEditCard>
  ...
  okText="Yes"
  cancelText="No"
  onConfirm={() => deleteProductionStagesData(productionStagesId)}
>
  <DeleteIcon type="delete" style={{ cursor: "pointer", color: "red" }} />
                 ...
                 <span>
                     ...
                     {productionProcessStages.probability === 0 || productionProcessStages.probability === 100 ? null :
...
export default connect(mapStateToProps, mapDispatchToProps)(SingleProductionStages);
