...
export const GET_PAYMENT_COUNT_REQUEST = "GET_PAYMENT_COUNT_REQUEST";
export const GET_PAYMENT_COUNT_SUCCESS = "GET_PAYMENT_COUNT_SUCCESS";
export const GET_PAYMENT_COUNT_FAILURE = "GET_PAYMENT_COUNT_FAILURE";
