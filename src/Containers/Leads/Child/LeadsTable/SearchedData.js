   ...
   return (
    ...
    <>
     ...
     <div className=" flex  w-[92%] max-sm:hidden p-1 bg-transparent font-bold sticky top-0 z-10">
      <div className=" w-[15.1rem] max-xl:w-[12.1rem] max-lg:w-[7.1rem]  max-xl:text-[0.65rem] max-lg:text-[0.45rem]">Type</div>
      ...
      > */}
       {/* { !fetchingTeamLeadsHot && teamLeadsHot.length === 0 ?<NodataFoundPage />: */}
       {props.serachedData.map((item,index) =>  {
