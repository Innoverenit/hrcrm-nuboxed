   ...
   return (
    ...
    <>
      ...
      <div className=" flex  w-[92%]  max-sm:hidden p-1 bg-transparent font-bold font-poppins !text-lm sticky  max-xl:text-[0.65rem] max-lg:text-[0.45rem]  z-10">
        <div className="flex items-center w-[6.1rem]  max-xl:w-[12.1rem] max-lg:w-[7.1rem]  text-white bg-blue-600 truncate justify-center "> {props.translatedMenuItems[13]}</div>
      ...
      <InfiniteScroll
        ...
        hasMore={hasMore}
        loader={fetchingTeamLeadsCold?<div><BundleLoader/></div>:null}
        height={"24vh"}
