...
<div className="custom-loader" ><img src={FWLogo1}   className="w-12 -mt-[5.5rem]"  alt="Loading..."  /></div>
   ...
   return (
    ...
    <>
        ...
        <div className=" w-[6.1rem] max-xl:w-[12.1rem] max-lg:w-[7.1rem]  max-xl:text-[0.65rem] max-lg:text-[0.45rem] text-white bg-red-600 truncate justify-center "> {translatedMenuItems[0]}</div>
        ...
        <div className=" w-[4.23rem] max-xl:w-[6.2rem] max-xl:text-[0.65rem] truncate max-lg:text-[0.45rem]"><AccountCircleIcon className="!text-icon  text-[#d64933]"/> {translatedMenuItems[8]} </div>
        <div className=" w-[2.9rem] max-xl:w-[2.2rem] max-lg:w-[4.2rem] truncate max-xl:text-[0.65rem] max-lg:text-[0.45rem]">{translatedMenuItems[9]}</div>
        <div className=" w-[3.5rem] max-xl:w-[4.5rem] max-lg:w-[3.5rem] truncate max-xl:text-[0.65rem] max-lg:text-[0.45rem]">{translatedMenuItems[10]}</div>
        <div className=" w-[5.3rem] max-xl:w-[3.3rem] max-lg:w-[6.3rem] truncate max-xl:text-[0.65rem] max-lg:text-[0.45rem]"><ConnectWithoutContactIcon className="!text-icon cursor-pointer text-[blue]"/>{translatedMenuItems[11]}</div>
