...
import {addLeadsActivityTask} from "../../LeadsAction"
 ...
 const handleprojectOptions = (filterOptionKey, filterOptionValue) => {
  ...
  useEffect(()=> {
    ...
    const {
      ...
      addingLeadsActivityTask,
      isEditing,
      prefillTask,
      addLeadsActivityTask,
      startDate,
      endDate,
      deleteTask,
      deletingTask,
            ...
            <div className="relative mt-1">
              ...
              <div class=" flex justify-end mt-4">
                ...
                <Button
                  type="primary"
                  htmlType="submit"
                  loading={isEditing ? updatingTask : addingLeadsActivityTask}
                >
                  {isEditing ? (
                    "Update"
                  ) : (
...
const mapStateToProps = ({
  ...
  addingLeadsActivityTask: leads.addingLeadsActivityTask,
...
export default connect(mapStateToProps, mapDispatchToProps)(LeadsTaskForm);
