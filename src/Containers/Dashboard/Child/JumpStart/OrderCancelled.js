  ...
  return (
   ...
   <OnlyWrapCard style={{ backgroundColor: "#eaedf1" }}>
        ...
        {/* <InfiniteScroll
          ...
          height={"75vh"}
        > */}
          {props.orderCancelList.length ?
            <>
              {props.orderCancelList.map((item) => {
...
<span>{item.payableOfferPrice}</span>
            ...
            !props.orderCancelList.length && !props.fetchingOrderCancelList ? <NodataFoundPage /> 
            : null}
        {/* </InfiniteScroll> */}
      </OnlyWrapCard>
    </>
...
export default connect(mapStateToProps, mapDispatchToProps)(OrderCancelled);
