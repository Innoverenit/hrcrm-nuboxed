...
function InvestorTeamCardList(props) {
  ...
  <div className=" flex justify-between max-sm:hidden  w-[84%]  p-1 bg-transparent font-bold sticky  z-10">
        <div className="font-bold font-poppins text-xs w-[19.6rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem] max-xl:w-[14.4rem] ">
        {translatedMenuItems[0]}
        {/* "Name" */}              
                </div>
        <div className="font-bold font-poppins text-xs w-[14.1rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem] max-xl:w-[16.1rem] max-lg:w-[18.1rem]">
        ...
        <div className="font-bold font-poppins text-xs w-[8.25rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem] max-xl:w-[8.2rem]">
        {translatedMenuItems[3]}
                   {/* Discussion */}
          </div>
          <div className=" font-bold font-poppins text-xs w-[5.24rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem] max-xl:w-[8.2rem]">
          ...
          <div className="font-bold font-poppins text-xs w-[7.34rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem] max-xl:w-[9.34rem] max-lg:w-[12.34rem]">
       ...
       {/* Shares # */}
        ...
        {/* Value */}
          ...
          <div className="font-bold font-poppins text-xs w-[9.21rem] max-xl:text-xs max-lg:text-[0.45rem] max-xl:w-[8.2rem]">
        ...
        {date === currentdate ? (
          <span class="text-[tomato] mt-[0.4rem] font-bold ml-1 text-[0.65rem]">
            New
                                ...
                                <div class="flex max-sm:justify-between max-sm:w-wk max-sm:items-center">
                                <div className=" flex   w-[7.1rem] items-center justify-center h-8 ml-gap bg-[#eef2f9] max-xl:w-[7.1rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">                         
                                     {/* Sector  */}
      ...
      <CurrencySymbol currencyType={item.userCurrency}/>  
         {`${Math.floor(item.totalProposalValue / 1000)}K`}
                                ...
                                <div className=" flex  items-center justify-center h-8 ml-gap bg-[#eef2f9] w-[5.12rem] max-xl:w-[3.1rem] max-lg:w-[1.1rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
                                   {/* Category */}
                                ...
                                <div className=" flex  items-center justify-center h-8 ml-gap bg-[#eef2f9] w-[6.211rem] max-xl:w-[4.911rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
                                   {/* Source */}
                                    <div class=" text-xs  font-poppins max-xl:text-[0.65rem] max-lg:text-[0.45rem] max-sm:text-sm">
                                    {item.source}
                                    </div>
                                ...
                                <div class="flex max-sm:justify-between max-sm:w-wk max-sm:items-center">
                                <div className=" flex  items-center justify-center h-8 ml-gap bg-[#eef2f9]  w-[3.117rem] max-xl:w-[3.1rem] max-lg:w-[1.1rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
                             {/* sHARES*/}
