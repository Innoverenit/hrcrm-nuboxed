                    ...
                    return (
                        <div>
                            <div className="flex justify-between rounded-xl  mt-2 bg-white h-11 items-center p-3 max-sm:h-[9rem] max-sm:flex-col"
                                ...
                                <div className=" flex font-medium  md:w-[12.8rem] max-sm:flex-row max-sm:w-auto ">
                                <div>
        ...
        {date === currentdate ? (
          <span class="text-[tomato] mt-[0.4rem] font-bold">
            New
                                ...
                                <div className=" flex font-medium flex-col  w-[14.1rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
                                ...
                                <div class="flex max-sm:justify-between max-sm:w-wk max-sm:items-center">
                                <div className=" flex font-medium flex-col w-[7.21rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
                     ...
                     {item.countryAlpha2Code}
                                ...
                                <div className=" flex font-medium flex-col w-[3.1rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
                                ...
                                <div className=" flex font-medium flex-col w-[12.124rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
                                ...
                                <div className=" flex font-medium flex-col w-[6.1rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
              ...
              {item.assignedTo === null ? (
                ...
                />
                                ...
                                <div className=" flex font-medium flex-col w-[8.1rem] max-sm:flex-row max-sm:w-auto mb-1 max-sm:justify-between ">
