...
function InvestorCardList(props) {
  ...
  <div class="rounded-lg m-5 max-sm:m-1 p-2 w-[96%] max-sm:w-wk overflow-auto shadow-[4px_0px_9px_3px_] shadow-[#a3abb980] bg-[#E3E8EE]">
        ...
        <div className=" w-[13.4rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem] max-xl:w-[14.4rem]"><FormattedMessage
                  ...
                  defaultMessage="Name"
                /></div>
        <div className=" w-[13.1rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem] max-xl:w-[16.1rem]"><FormattedMessage
                  id="app.sector"
                  defaultMessage="Sector"
                /></div>
        <div className=" w-[6.2rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem] max-xl:w-[6.2rem] "><FormattedMessage
                  id="app.country"
                  defaultMessage="Country"
                /></div>
        <div className="w-[7.12rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem] max-xl:w-[5.12rem]"># <FormattedMessage
                  id="app.deals"
        ...
        <div className="w-[8.21rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem] max-xl:w-[8.21rem]"><FormattedMessage
                ...
                /></div>
        <div className="w-[7.34rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem] max-xl:w-[9.34rem]">
        <FormattedMessage
                  id="app.source"
                    ...
                    return (
                        <div>
                            <div className="flex justify-between rounded-xl  mt-2 bg-white h-11 items-center p-3 max-sm:h-[9rem] max-sm:flex-col"
                                ...
                                <div className=" flex font-medium  w-[12.8rem] max-xl:w-[7.8rem] max-sm:flex-row max-sm:w-auto ">
                                <div>
        ...
        {date === currentdate ? (
          <span class="text-[tomato] mt-[0.4rem] font-bold">
            New
                                ...
                                <div className=" flex font-medium flex-col  w-[14.1rem] max-xl:w-[8.1rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
                                ...
                                <div class="flex max-sm:justify-between max-sm:w-wk max-sm:items-center">
                                <div className=" flex font-medium flex-col w-[7.21rem] max-xl:w-[4.21rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
                     ...
                     {item.countryAlpha2Code}
                                ...
                                <div className=" flex font-medium flex-col w-[3.1rem] max-xl:w-[3.1rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
                                ...
                                <div className=" flex font-medium flex-col w-[12.124rem] max-xl:w-[4.124rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
                                ...
                                <div className=" flex font-medium flex-col w-[6.1rem] max-xl:w-[6.1rem] max-sm:flex-row max-sm:w-auto max-sm:justify-between ">
              ...
              {item.assignedTo === null ? (
                ...
                />
                                ...
                                <div className=" flex font-medium flex-col w-[8.1rem] max-xl:w-[2.1rem] max-sm:flex-row max-sm:w-auto mb-1 max-sm:justify-between ">
