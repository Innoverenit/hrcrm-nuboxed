...
import {getAllEmployeelist,createDeals} from "../../../../Investor/InvestorAction"
...
const mapStateToProps = ({ auth,source,investor, opportunity,deal,settings,employee, contact, customer }) => ({
  ...
  creatingDeal: investor.creatingDeal,
  creatingDealError: investor.creatingDealError,
