...
const OrderRepairOrgCard = (props) => {
  ...
  const [loading1, setLoading1] = useState(false);
    ...
    const fetchData1 = async () => {
      ...
      try {
        const response = await axios.get(`${base_url2}/dashboard/allOrder/${props.orgId}/${props.startDate}/${props.endDate}/${page}`,{
          headers: {
...
{item.priority === "High" && (
  ...
  const mapDispatchToProps = (dispatch) =>
    ...
    export default connect(mapStateToProps, mapDispatchToProps)(OrderRepairOrgCard);
