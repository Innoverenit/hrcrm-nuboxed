...
const OrderRepairCompletedOrgCard = (props) => {
  ...
  const [loading1, setLoading1] = useState(false);
    ...
    const fetchData1 = async () => {
      ...
      try {
        const response = await axios.get(`${base_url2}/dashboard/completeOrders/${props.orgId}/${props.startDate}/${props.endDate}/${page}`,{
          headers: {
    ...
    useEffect(() => {
      if (props.selectedCategory==="Orders"){
        fetchData1();
      }
...
{item.priority === "High" && (
  ...
  const mapDispatchToProps = (dispatch) =>
    ...
    export default connect(mapStateToProps, mapDispatchToProps)(OrderRepairCompletedOrgCard);
