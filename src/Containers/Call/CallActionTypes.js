...
export const ADD_CALL_LOCATION_REQUEST = "ADD_CALL_LOCATION_REQUEST";
export const ADD_CALL_LOCATION_SUCCESS = "ADD_CALL_LOCATION_SUCCESS";
export const ADD_CALL_LOCATION_FAILURE = "ADD_CALL_LOCATION_FAILURE";
