...
if (loading) {
  ...
  return (
    <>
      ...
      <div className=" max-sm:hidden flex justify-between w-[100%]  max-lg:w-[89%] max-xl:w-[96%] p-1 bg-transparent font-bold font-poppins max-xl:text-[0.65rem] max-lg:text-[0.45rem] !text-lm  sticky  z-10">
        <div class=" flex justify-between w-[89%]  items-end ">
        <div className=" w-[13.9rem] truncate text-[#00A2E8] text-sm  max-xl:w-[21.5rem] max-lg:w-[20.5rem]">
