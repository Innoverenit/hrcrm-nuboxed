...
function ContactSearchedData(props) {
  ...
  return (
    <>
      ...
      <div class="rounded m-1 max-sm:m-1 p-1 w-[99%]  max-sm:w-wk overflow-y-auto overflow-x-hidden shadow-[4px_0px_9px_3px_] shadow-[#a3abb980] bg-[white]">
      ...
      <div class=" flex justify-between w-[100%] font-bold  font-poppins !text-lm items-end ">
        ...
        { !props.fetchingContactInputSearchData && props.serachedDataContact.length === 0 ?<EmptyPage/>:props.serachedDataContact.map((item,index) =>  {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContactSearchedData);
