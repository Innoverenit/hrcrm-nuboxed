  ...
  return (
    <>
      ...
      <div class=" flex justify-between w-[100%] font-bold  font-poppins text-xs items-end ">
        <div className=" w-[21.9rem] text-[#00A2E8] truncate max-md:w-[21.9rem]  text-sm max-xl:w-[21.5rem] max-lg:w-[20.5rem]">
        ...
        {/* Designation */}
        <div className="w-[24rem] truncate max-md:w-[24.1rem]  max-xl:w-[10.1rem] max-lg:w-[7.1rem]">
