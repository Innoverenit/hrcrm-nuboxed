...
export const GET_LOCATION_SEARCH_REQUEST="GET_LOCATION_SEARCH_REQUEST";
export const GET_LOCATION_SEARCH_SUCCESS="GET_LOCATION_SEARCH_SUCCESS";
export const GET_LOCATION_SEARCH_FAILURE="GET_LOCATION_SEARCH_FAILURE";

export const HANDLE_CLAER_REDUCER_DATA_LOCATION = "HANDLE_CLAER_REDUCER_DATA_LOCATION";
