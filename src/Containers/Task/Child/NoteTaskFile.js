...
//import { TextareaComponent } from "../../../../../Components/Forms/Formik/TextareaComponent";
 import { addTaskNote } from "../TaskAction";
...
class NoteTaskFile extends Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <>
        <Formik
          ...
          onSubmit={(values, { resetForm }) => {
            ...
            addTaskNote({ ...values, notes: htmlBody }, this.createCallback);
            resetForm();
          }}
        >
          {({
...
const mapStateToProps = ({ auth, team, task }) => ({
  ...
  addingNotesList:task.addingNotesList,
...
export default connect(mapStateToProps, mapDispatchToProps)(NoteTaskFile);
