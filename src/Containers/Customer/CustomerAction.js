...
//   // const { userId } = getState("auth").auth.userDetails;
//   dispatch({
//     type: types.DELETE_CUSTOMER_DATA_REQUEST,
//   });
//   axios
//     .delete(`${base_url2}/customer/${id}`,
//       {
//         headers: {
//           Authorization: "Bearer " + sessionStorage.getItem("token") || "",
//         },
...
// export const getDeletedCustomers = () => (dispatch) => {
//   dispatch({
//     type: types.GET_DELETED_CUSTOMERS_REQUEST,
//   });
//   axios
//     .get(`${base_url2}/distributor/deleteCustomerHistory`, {
//       headers: {
//         Authorization: "Bearer " + sessionStorage.getItem("token") || "",
//       },
//     })
...
//       console.log(res);
//       dispatch({
//         type: types.GET_DELETED_CUSTOMERS_SUCCESS,
//         payload: res.data,
//       });
//     })
//     .catch((err) => {
//       console.log(err);
//       dispatch({
//         type: types.GET_DELETED_CUSTOMERS_FAILURE,
//         payload: err,
//       });
//     });
// };
...
// export const getDeletedOrderTableData = (CustomerId) => (dispatch) => {
//   dispatch({
//     type: types.FETCHING_CUSTOMER_DELETED_ORDER_BY_ID_REQUEST,
//   });
//   axios
//     .get(`${base_url2}/order/orderDeleteCustomer/${customerId}`, {
//       headers: {
//         Authorization: "Bearer " + sessionStorage.getItem("token") || "",
//       },
//     })
...
//       console.log(res);
//       dispatch({
//         type: types.FETCHING_CUSTOMER_DELETED_ORDER_BY_ID_SUCCESS,
//         payload: res.data,
//       });
//     })
//     .catch((err) => {
//       console.log(err);
//       dispatch({
//         type: types.FETCHING_CUSTOMER_DELETED_ORDER_BY_ID_FAILURE,
//         payload: err,
//       });
//     });
// };
// export const getDeletedQuoteTableData = (customerId) => (dispatch) => {
//   dispatch({
//     type: types.FETCHING_CUSTOMER_DELETED_QUOTE_BY_ID_REQUEST,
//   });
//   axios
//     .get(`${base_url2}/order/orderDeleteCustomer/${customerId}`,
//       {
...
//       console.log(res);
//       dispatch({
//         type: types.FETCHING_CUSTOMER_DELETED_QUOTE_BY_ID_SUCCESS,
//         payload: res.data,
//       });
//     })
//     .catch((err) => {
//       console.log(err);
//       dispatch({
//         type: types.FETCHING_CUSTOMER_DELETED_QUOTE_BY_ID_FAILURE,
//         payload: err,
//       });
//     });
// };

// export const deleteCustomerOrderData = (data, id) => (dispatch) => {
//   dispatch({
//     type: types.DELETE_CUSTOMER_ORDER_DATA_REQUEST,
//   });
//   axios
...
//       console.log(res);
//       dispatch({
//         type: types.DELETE_CUSTOMER_ORDER_DATA_SUCCESS,
//         payload: id,
//       });
//     })
//     .catch((err) => {
//       console.log(err);
//       dispatch({
//         type: types.DELETE_CUSTOMER_ORDER_DATA_FAILURE,
//         payload: err,
//       });
//     });
// };
