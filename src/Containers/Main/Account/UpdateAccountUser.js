...
function UpdateAccountUser(props) {
  ...
  const handleSelectUserFocus = () => {
    ...
    const fetchUser = async () => {
        ...
        try {
          ...
          const apiEndpoint = `${base_url}/employee/user-list/drop-down/erp`;
    ...
    props.updateAccountUser(props.RowData.distributorId,value)
  };
...
export default connect(mapStateToProps, mapDispatchToProps)(UpdateAccountUser);
