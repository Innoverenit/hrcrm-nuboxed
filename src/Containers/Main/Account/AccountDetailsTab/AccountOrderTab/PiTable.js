...
//     const [inputValues, setInputValues] = useState({}); // Track input values for manual mode
...
//                                     value={inputValues[item.phoneId]?.itemId || ""}
//                                     onChange={(e) => handleInputChange('itemId', item.phoneId, e.target.value)}
//                                 />
//                             </div>
