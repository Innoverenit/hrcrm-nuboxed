      ...
      <Formik
        ...
        onSubmit={(values, { resetForm }) => {
          console.log(
            "entryAmount:",
            values.entryAmount,
            typeof values.entryAmount
          );
          console.log(
            "remainingTotalValue:",
            props.particularRowData.remainingTotalValue,
            typeof props.particularRowData.remainingTotalValue
          );

          if (props.activeTab === "11") {
            if (
              Number(values.entryAmount) <=
                Number(props.particularRowData.remainingTotalValue) &&
            ...
            props.addPaidRepairOrder(
              ...
              props.particularRowData.orderPhoneId
                ? props.particularRowData.orderPhoneId
                : props.particularRowData.procureOrderInvoiceId,
              props.distributorId
            );
            ...
            <div class="max-sm:flex-col">
              <div class=" h-full w-wk max-sm:w-wk">
                <div class="flex justify-between">
                  <div class="w-[40%]">
                    <div class="text-xs font-poppins font-bold">
                ...
                <div class=" ">
                  <div class="mt-1 justify-end">
                    ...
                    <Field name="docId" isRequired component={DragableUpload} />
                  </div>
                </div>
              </div>
            </div>
