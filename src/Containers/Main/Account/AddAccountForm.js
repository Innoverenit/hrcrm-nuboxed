...
const AddAccountForm = ({
  ...
  const fetchCrmData = () => {
    if (!fetchingCrm && crmAllData.length === 0) {
      getCrm(); 
    }
  };
          ...
          <Form class="form-background h-[77vh]">
            <div class=" flex justify-between max-sm:flex-col ">
                ...
                <div class="flex justify-between mt-2">
                  ...
                  <div class="w-w47.5.5">
                    ...
                    <Field
                      ...
                      component={SelectComponent}
                      options={
                        Array.isArray(clientCustomerOptions)
              ...
              <div class=" h-full w-w47.5.5 max-sm:w-wk">
                    ...
                    {({ open }) => (
                      <>
                        <div className="relative ">
                          <Listbox.Button
                            style={{
                              boxShadow: "rgb(170, 170, 170) 0px 0.25em 0.62em",
                            }}
                          ...
                          {open && (
                            ...
                            >
                              {fetchingCrm ? (
                              <div className="text-center p-2"><BundleLoader/></div>
                            ) : (
                              crmAllData.map((item) => (
                                <Listbox.Option
                                  key={item.employeeId}
                ...
                <div class="mt-4">
                  <ReactDescription setText={setText} text={text} />
                </div>
              </div>
            </div>
