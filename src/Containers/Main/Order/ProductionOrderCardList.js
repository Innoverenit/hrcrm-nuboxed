      ...
      <div className=" flex sticky z-auto">
        <div class="rounded m-1 max-sm:m-1 p-1 w-[100%]  overflow-auto shadow-[4px_0px_9px_3px_] shadow-[#a3abb980] bg-[white]">
          ...
          <InfiniteScroll
            ...
            hasMore={hasMore}
            loader={
              fetchingProductionOrder || fetchingCustomerPagination ? (
            ...
            height={"83vh"}
          >
            {!fetchingProductionOrder && productionOrder.length === 0 ? (
              <NodataFoundPage />
            ) : (
              productionOrder.map((item, index) => {
                                ...
                                <div class="flex max-sm:flex-row justify-between w-full md:flex-col">
                                  <div class="flex  items-center justify-center text-xs text-blue-500  font-poppins font-semibold  cursor-pointer">
                                    ...
                                    >
                                      ...
                                      {date === currentdate ? (
                                        <span
                                          className=" font-bold text-[tomato] text-[0.65rem]"
                                          style={{
                                            color: "tomato",
                                            fontWeight: "bold",
                                          }}
