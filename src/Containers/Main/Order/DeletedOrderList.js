...
function DeletedOrderList(props) {
  ...
  const handleLoadMore = () => {
    setPage(page + 1);
    props.getDeletedHighOrderList(
      props.userId,
      props.currentUser ? props.currentUser : page,
      "High"
    );
  };
  ...
  const handleLoadMoreMedium = () => {
    setPage(page + 1);
    props.getDeletedMediumOrderList(
      props.userId,
      props.currentUser ? props.currentUser : page,
      "Medium"
    );
            ...
            <div class="rounded m-1 p-1 w-[100%] overflow-auto shadow-[4px_0px_9px_3px_] shadow-[#a3abb980] bg-[white]">
              <div className=" flex justify-between w-full p-1 bg-transparent !text-lm sticky font-bold font-poppins z-10 max-sm:hidden">
                ...
                <div className=" w-[11.3rem]  truncate max-md:w-[8.6rem]">
                  <ApartmentIcon className="!text-icon    text-[#43e035]" />{" "}
              ...
              <InfiniteScroll
                ...
                hasMore={hasMore}
                loader={
                  props.fetchingDeletedHighOrderList ? (
                            ...
                            <div class="flex">
                              ...
                              <div className=" flex   max-sm:flex-row  max-sm:justify-between  ">
                                ...
                                <div class="flex text-xs  font-poppins items-center justify-center h-8   bg-[#eef2f9]">
                                  <Tooltip
                                    title={props.translatedMenuItems[27]}
                                  >
                                    <NoteAltIcon
                              ...
                              <div className=" flex  max-sm:flex-row  max-sm:justify-between  ">
                                <div class="flex text-xs  font-poppins items-center justify-center h-8  bg-[#eef2f9] ">
                                  <Tooltip
                                    title={props.translatedMenuItems[34]}
                                  >
                                    <PersonAddAlt1
          ...
          <div className=" flex sticky  z-auto">
            <div class="rounded m-1 p-1 w-[100%] overflow-auto shadow-[4px_0px_9px_3px_] shadow-[#a3abb980] bg-[white]">
              <div className=" flex justify-between w-full !text-lm p-1 bg-transparent font-bold font-poppins sticky  z-10 max-sm:hidden">
                <div className="w-[3.54rem] truncate  max-md:w-[3.54rem] text-[white] flex justify-center bg-[teal]">
              ...
              <InfiniteScroll
                ...
                hasMore={hasMore}
                loader={
                  props.fetchingDeletedLowOrderList ? (
                    <div style={{ textAlign: "center" }}>
                      <BundleLoader />
                    </div>
                  ) : null
