          ...
          <div className=" flex justify-end sticky  z-auto">
            <div class="rounded m-1 max-sm:m-1 p-1 w-[100%]  overflow-auto shadow-[4px_0px_9px_3px_] shadow-[#a3abb980] bg-[white]">
              ...
              <InfiniteScroll
                ...
                hasMore={hasMore}
                loader={
                  props.fetchingAllHighOrderList ? (
                    <div>
                      <BundleLoader />
                    </div>
                  ) : null
                 ...
                 Country : ${
                   ...
                   PostalCode : ${
                    ...
                    return (
                      <div>
                        <div
                          className="flex rounded justify-between  mt-1 bg-white h-8 items-center  max-sm:rounded-lg  max-sm:bg-gradient-to-b max-sm:from-blue-200 max-sm:to-blue-100 max-sm:border-b-4 max-sm:border-blue-500 max-sm:h-[9rem] max-sm:flex-col 
                                ...
                                <div class="flex max-sm:flex-row justify-between w-full ">
                                  <div class=" text-xs text-blue-500  font-poppins font-semibold  cursor-pointer">
                                    ...
                                    {item.priority === "Medium" && (
                                      <div class="border rounded-[50%] h-6 w-6 bg-[#0f0e0d]"></div>
                                    )}
                                    {item.priority === "Low" && (
                          ...
                          <div class="flex max-sm:justify-between max-sm:w-wk max-sm:items-center">
                            ...
                            <div class=" flex">
                              ...
                              <div class="flex flex-row items-center justify-center h-8 ml-gap  bg-[#eef2f9] md:w-[3.024rem] max-sm:flex-row w-full max-sm:justify-between">
                                <div>
                                  {show &&
                                  particularRowData.orderId === item.orderId ? (
                                    <div class=" flex justify-between">
                                      <Select
                                        className="w-[350px]"
                                        value={lead}
                                        onChange={(value) =>
                                          handleLeadData(value)
                                        }
                                      >
                                        {props.departmentUser.map((a) => {
                                          return (
                                            <Option value={a.employeeId}>
                                              {a.empName}
                                            </Option>
                                          );
                                        })}
          ...
          <div className=" flex justify-end sticky  z-auto">
            <div class="rounded m-1 max-sm:hidden max-sm:m-1 p-1 w-[100%]  overflow-auto shadow-[4px_0px_9px_3px_] shadow-[#a3abb980] bg-[white]">
              <div className=" flex justify-between w-full p-1 bg-transparent font-bold sticky items-end z-10 max-sm:hidden">
                <div className="font-bold font-poppins text-xs md:w-[3rem] text-[white] flex justify-center bg-[teal]">
                ...
                <div className="font-bold font-poppins text-xs md:w-[8.6rem]">
                  <ApartmentIcon className="!text-base mr-1 text-[#e4eb2f]" />
                  {props.translatedMenuItems[18]}
                </div>
                <div className="font-bold font-poppins text-xs md:w-[4.051rem] ">
                  {" "}
                  <ContactsIcon className="!text-base   text-[#196820]" />
                  {props.translatedMenuItems[19]}
                </div>
                <div className="font-bold font-poppins text-xs md:w-[5.018rem]">
                  {props.translatedMenuItems[20]}
                </div>
                <div className="font-bold font-poppins text-xs md:w-[5.03rem]">
                  <DateRangeIcon className="!text-icon " />
                  {props.translatedMenuItems[15]}
                </div>
                <div className="font-bold font-poppins text-xs md:w-[5.031rem]">
                  <AccountCircleIcon className="!text-icon  text-[#f28482]" />
                  {props.translatedMenuItems[21]}
                </div>
                ...
                <div className="font-bold font-poppins text-xs md:w-[9.76rem]">
                  <GroupsIcon className="!text-base mr-1    text-[#831f68]" />
                  {props.translatedMenuItems[23]}
                </div>
