...
const Order = (props) => {
 ...
 "1486",// Track 70
  ...
  useEffect(() => {
    const { repairInd, ecomModInd, tradingInd, orderManagementInd, productionInd } = props.user.moduleMapper;
  ...
  return (
      ...
      <React.Fragment>
        ...
        />
          ...
          {viewType === "list" && props.user.moduleMapper.repairInd === true && props.user.moduleMapper.orderManagementInd ? (
            <OrderTableByUserID
            selectedLanguage={selectedLanguage}
         translateText={translateText}
         translatedMenuItems={translatedMenuItems}
         />
            ) : viewType === "production" && props.user.moduleMapper.productionInd === true && props.user.moduleMapper.orderManagementInd ? (
         ...
         />
            ...
            translatedMenuItems={translatedMenuItems}
            />
          ) : viewType === "procure" && props.user.moduleMapper.tradingInd && props.user.moduleMapper.orderManagementInd ? (
            <ProcreCardList 
            selectedLanguage={selectedLanguage}
         translateText={translateText}
         translatedMenuItems={translatedMenuItems}
         />
          ) : viewType === "ecom" && props.user.moduleMapper.ecomModInd && props.user.moduleMapper.orderManagementInd ? (
            <CommerceTab
            selectedLanguage={selectedLanguage}
         translateText={translateText}
         translatedMenuItems={translatedMenuItems}
