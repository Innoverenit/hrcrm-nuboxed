        ...
        <div className="flex  sticky h-[80vh] z-auto">
          <div className="rounded max-sm:m-1 m-1 p-1 w-full overflow-auto shadow-[4px_0px_9px_3px_] shadow-[#a3abb980] bg-[#eaedf1]">
            <div className="flex max-sm:hidden justify-between w-[100%]  p-1 bg-transparent font-bold sticky  z-10">
              ...
              <div className="text-[#00A2E8] text-base font-poppins font-bold text-xs md:w-[7.4rem]">
                  ...
                  <div key={item.id}>
                    <div className="flex rounded mt-1 bg-white h-8 items-center  max-sm:h-[7rem] max-sm:flex-col">
                      <div className="flex w-3/4">
                        <div className="flex font-medium flex-col border-l-2 border-green-500 bg-[#eef2f9] md:w-[1.56rem] max-sm:w-full">
                          {dayjs(item.creationDate).format("ll")}
                        </div>
                        <div className="flex font-medium flex-col md:w-[7.4rem] items-center justify-center h-8 ml-gap  bg-[#eef2f9] max-sm:flex-row w-full max-sm:justify-between">
