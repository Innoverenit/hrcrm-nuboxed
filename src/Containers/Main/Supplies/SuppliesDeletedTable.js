   ...
   <div className=" flex  sticky  z-auto">
        <div class="rounded m-1 max-sm:m-1 p-1 w-full overflow-auto shadow-[4px_0px_9px_3px_] shadow-[#a3abb980] bg-[#eaedf1]">
          <div className=" flex max-sm:hidden justify-between w-[100%]  p-1 bg-transparent font-bold sticky  z-10">
            ...
            <div className="font-bold font-poppins text-xs w-[5.1rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem]">
              {/* Name */}
            ...
            <div className="font-bold font-poppins text-xs w-[4.8rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem]">
              {/* Attribute */}
            ...
            <div className="font-bold font-poppins text-xs w-[4.23rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem]">
              {/* Created */}
              {translatedMenuItems[6]}
              </div>
            <div className="font-bold font-poppins text-xs w-[7.2rem] max-xl:text-[0.65rem] max-lg:text-[0.45rem]">
              {/* Reinstate */}
...
<span>
                              ...
                              <div class="max-sm:w-auto flex items-center">
                                ...
                                <div className=" flex  w-[10rem] max-xl:w-[5rem] max-lg:w-[3rem] max-sm:w-auto max-sm:justify-between  max-sm:flex-row ">
                    ...
                    <span className="text-[0.65rem] text-[tomato] font-bold">
                      New
                          ...
                          <div className=" flex  w-[9.1rem] max-xl:w-[6.5rem] max-lg:w-[4.5rem]  max-sm:w-auto max-sm:justify-between  max-sm:flex-row ">
                            <div class="  text-[0.82rem] max-sm:text-[0.82rem]  font-poppins max-xl:text-[0.65rem] max-lg:text-[0.45rem]">
                              {item.suppliesName}
                            </div>
                          </div>
                          ...
                          <div class="flex max-sm:justify-between max-sm:w-wk items-center">
                          <div className=" flex  w-[9.81rem] max-xl:w-[8.1rem] max-lg:w-[6.6rem] max-sm:w-auto max-sm:justify-between  max-sm:flex-row ">
                            <div class="  text-[0.82rem] max-sm:text-[0.82rem]  font-poppins max-xl:text-[0.65rem] max-lg:text-[0.45rem]">
                              {item.categoryName}
                            </div>
                          </div>

                          <div className=" flex  w-[9.3rem] max-xl:w-[6.23rem] max-lg:w-[5.23rem] max-sm:w-auto max-sm:justify-between  max-sm:flex-row ">
                            <div class="  text-[0.82rem] max-sm:text-[0.82rem]  font-poppins max-xl:text-[0.65rem] max-lg:text-[0.45rem]">
                              {item.subCategoryName}
                            </div>
                          </div>
                          <div className=" flex  w-[8.12rem] max-xl:w-[6.32rem] max-lg:w-[5.32rem] max-sm:w-auto max-sm:justify-between  max-sm:flex-row ">
                            <div class="  text-[0.82rem] max-sm:text-[0.82rem]  font-poppins max-xl:text-[0.65rem] max-lg:text-[0.45rem]">
                          ...
                          <div class="flex max-sm:justify-between max-sm:w-wk items-center">
                          <div className=" flex  w-[9.41rem] max-xl:w-[6.2rem] max-lg:w-[3.8rem] max-sm:w-auto max-sm:justify-between  max-sm:flex-row ">
                            <div class="  text-[0.82rem] max-sm:text-[0.82rem]  font-poppins max-xl:text-[0.65rem] max-lg:text-[0.45rem]">
                              {item.reorder}
                            </div>
                          </div>
                          <div className=" flex  w-[9.2rem] max-xl:w-[5rem] max-lg:w-[3rem] max-sm:w-auto max-sm:justify-between  max-sm:flex-row ">
                            <div class="  text-[0.82rem] items-center flex max-sm:text-[0.82rem]  font-poppins max-xl:text-[0.65rem] max-lg:text-[0.45rem]">
                            <MultiAvatar
