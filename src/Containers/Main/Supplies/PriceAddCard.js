...
//        setreduceData(prevData => 
//         prevData.map(cat =>
//           cat.suppliesFactorId === item.suppliesFactorId ? response.data : cat
//         )
//       );
//       //  dispatch(getPriceFactor(props.particularDiscountData.suppliesId));
//        if (response.data === 'Successfully !!!!') {
