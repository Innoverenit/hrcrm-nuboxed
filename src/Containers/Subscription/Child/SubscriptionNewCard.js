...
useEffect(() => {
  ...
  const removeSubscription = (id) => {
    props.removeSubscriptionData(id,props.userId)
      ...
      <div style={{ 
        ...
        {subscriptions.map((sub, subIndex) => (
          <Card
            ...
            style={{ width: 300, margin: '10px',backgroundColor:"cadetblue" }}
            actions={[
              <Popconfirm
              title="Confirm Subscription Delete?"
              onConfirm={() => removeSubscription(sub.subscriptionId)}
  ...
  <Popconfirm
              title="Confirm Subscription Delete?"
              onConfirm={() => props.removeSubscriptionRules(rule.subscriptionRuleId,props.userId,rule.subscriptionId)}
              // onCancel={handleCancel}
              okText="Ok"
              cancelText="Cancel"
          >
