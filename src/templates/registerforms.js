                    ...
                    <div className="demo">
                        <div className="login">
                            ...
                            <div className="login__form">
                                ...
                                <button type="button" className="login__submit">Sign Up</button>
                        ...
                        <div className="app">
                            <div className="app__top">
                                ...
                                <div className="app__user">
                                    <img src="../../Assets/Images/mountain.jpg" alt="" className="app__user-photo" />
                            ...
                            <div className="app__bot">
                                ...
                                <div className="app__meetings">
                                    <div className="app__meeting">
                                        <img src="../../Assets/Images/mountain.jpg" alt="" className="app__meeting-photo" />
